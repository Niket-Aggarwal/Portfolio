...
const Hero = () => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid items-center gap-20 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            {/* Developer Visual */}
            <div className="relative mx-auto h-[380px] w-full max-w-md sm:h-[450px]">
              {/* Outer frame */}
              <div className="absolute inset-0 rounded-[2rem] border border-white/10 bg-white/[0.018] backdrop-blur-[2px]" />

              {/* Inner frame */}
              <div className="absolute inset-6 rounded-[1.5rem] border border-white/[0.06]" />

              {/* Center */}
              <div className="absolute left-1/2 top-1/2 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/15 bg-white/[0.045] text-4xl font-semibold text-white shadow-[0_0_80px_rgba(255,255,255,0.06)]">
                N
              </div>
      ...
      <section
        id="about"
        className="flex min-h-[110vh] items-center border-t border-white/[0.05] px-6 py-32 sm:px-10 lg:px-16"
      >
        <div className="mx-auto w-full max-w-7xl">
          <SectionTitle
            number="01 — About"
          ...
          <div className="mt-20 grid gap-5 md:grid-cols-3">
            {["Curious", "Focused", "Always Learning"].map((item, index) => (
              <div
                key={item}
                className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-8 transition-all duration-500 hover:-translate-y-1 hover:border-white/15 hover:bg-white/[0.04]"
              >
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-20 flex flex-wrap gap-3">
            {[
              ...
              <div
                key={skill}
                className="rounded-full border border-white/10 bg-white/[0.025] px-5 py-3 text-sm text-zinc-400 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.06] hover:text-white"
              >
                {skill}
              </div>
            ))}
      ...
      <section
        id="projects"
        className="flex min-h-[120vh] items-center border-t border-white/[0.05] px-6 py-32 sm:px-10 lg:px-16"
      >
        <div className="mx-auto w-full max-w-7xl">
          <SectionTitle
            number="04 — Projects"
          ...
          <div className="mt-20 grid gap-5 md:grid-cols-2">
            {[1, 2, 3, 4].map((project) => (
              <div
                key={project}
                className="group min-h-[320px] rounded-[1.5rem] border border-white/[0.07] bg-white/[0.02] p-6 transition-all duration-500 hover:-translate-y-2 hover:border-white/15 hover:bg-white/[0.04]"
              >
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a
                href="#"
                className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-5 py-3 text-sm text-zinc-400 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.06] hover:text-white"
              >
                <FiGithub size={17} />
                GitHub
              </a>
